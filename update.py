...
with open('_data/negocio-solidario.csv', mode='w', encoding='utf-8', newline='\n') as ns:
    ...
    duplicados = [0,1,2,39,41,52,64,70,77,101,132,138,152,161,162,168,169,178,179,180,189]
    excluidos = [156,166]
